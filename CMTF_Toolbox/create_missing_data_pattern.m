...
%CREATE_MISSING_DATA_PATTERN Creates a randomly missing element indicator tensor.
%
%   W = CREATE_MISSING_DATA_PATTERN(SZ,M) creates an indicator (binary) tensor W of the
