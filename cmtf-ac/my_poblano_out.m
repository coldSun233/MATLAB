function out = my_poblano_out(x,f,g,nfev,params,out)
...
%% Check if this is the first call
    ...
    elseif isnan(f) || sum(isnan(g))
        % new point found results in NaNs
        out.ExitFlag = 4;
        out.ExitDescription = 'NaNs found in F, G';
    end
    ...
    if strcmp(params.Results.Display, 'iter') && (mod(out.Iters,params.Results.DisplayIters)==0 || out.ExitFlag>=0)
        fprintf(1,'%6d %9d   %16.12f\n', out.Iters, out.FuncEvals, f);
    end
